 ...
 * @author Pratik
 */
public class CommunityAutomateWorkRequestJPanel extends javax.swing.JPanel {
  //userProcessContainer, userAccount, enterprise, network);
    /**
     * Creates new form CommunityAutomateWorkRequestJPanel
     */
    ...
    public CommunityAutomateWorkRequestJPanel(JPanel userProcessContainer,UserAccount userAccount,Enterprise enterprise,Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Threshold for Power Shortfall");

        txtSetThresholdLevelForSupply.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtSetThresholdLevelForSupplyActionPerformed(evt);
            }
        });
    ...
    private void savejButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savejButtonActionPerformed
       ...
       if (!ValidateThresholdNumber()) {
            JOptionPane.showMessageDialog(this, "Enter Valid Number for Threshold Short fall Power", "Automate Request", JOptionPane.ERROR_MESSAGE);
        } else if (Integer.parseInt(txtSetThresholdLevelForSupply.getText()) <= 0) {
            JOptionPane.showMessageDialog(this, "Enter a Positive Number for Threshold Short fall Power", "Automate Request", JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    private void txtSetThresholdLevelForSupplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSetThresholdLevelForSupplyActionPerformed
        // TODO add your handling code here:
        savejButton.setEnabled(true);
    }//GEN-LAST:event_txtSetThresholdLevelForSupplyActionPerformed
