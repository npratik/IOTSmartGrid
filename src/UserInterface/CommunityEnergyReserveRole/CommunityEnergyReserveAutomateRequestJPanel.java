 ...
 * @author Pratik
 */
public class CommunityEnergyReserveAutomateRequestJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form CommunityEnergyReserveAutomateRequestJPanel
     */
    public CommunityEnergyReserveAutomateRequestJPanel(JPanel userProcessContainer, UserAccount userAccount, CommunityEnergyReserveEnterprise enterprise, Network network) {
        initComponents();
    ...
    private void savejButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savejButtonActionPerformed
        ...
        if (!ValidateThresholdNumber()) {
            JOptionPane.showMessageDialog(this, "Enter Valid Number for Threshold Power Supply", "Automate Request", JOptionPane.ERROR_MESSAGE);
        } else if (Integer.parseInt(txtSetThresholdLevelForSupply.getText()) <= 0) {
            JOptionPane.showMessageDialog(this, "Enter a Positive Number for Threshold Power Supply", "Automate Request", JOptionPane.ERROR_MESSAGE);
        } else {
